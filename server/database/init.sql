...
--insert into PetOwner (username, ownerName, age) values ('robertcunningham42', 'Robert Cunningham', 42);
...
--insert into PetOwner (username, ownerName, age) values ('jennychan00', 'Jenny Chan', 30);
...
--insert into PetOwner (username, ownerName, age) values ('zzsaf7', 'Ploddy Romanini', 67);
...
--insert into CareTaker (username, carerName, age) values ('harlenglasgow23', 'Harlen Glasgow', 54);
...
--insert into CareTaker (username, carerName, age) values ('juleswestcot69', 'Jules Westcot', 56);
...
--insert into Fulltimer (username) values ('harlenglasgow23');
...
--insert into Parttimer (username) values ('juleswestcot69');
...
--
---- Owned_Pet_belongs --
--insert into Owned_Pet_Belongs (pouname, pettype, petname, petage) values ('jennychan00', 'Tortoise', 'Ploddy', 15);
--insert into Owned_Pet_Belongs (pouname, pettype, petname, petage) values ('robertcunningham42', 'Free-range Birds', 'Chirpy', 5);
...
--insert into Owned_Pet_Belongs (pouname, pettype, petname, petage) values ('robertcunningham42', 'Aquarium Fish', 'Farr', 17);
...
--insert into Cares (ctuname, pettype, price) values ('bgillionai', 'Tortoise', 52);
...
--insert into Cares (ctuname, pettype, price) values ('sbagge4', 'Tortoise', 77);
...
--insert into Cares (ctuname, pettype, price) values ('harlenglasgow23', 'Caged Birds', 69);
--insert into Cares (ctuname, pettype, price) values ('harlenglasgow23', 'Free-range Birds', 80);
--insert into Cares (ctuname, pettype, price) values ('harlenglasgow23', 'Tortoise', 40);
--insert into Cares (ctuname, pettype, price) values ('gmonnelly2', 'Pitbull', 50);
--insert into Cares (ctuname, pettype, price) values ('gmonnelly2', 'Free-range Birds', 50);
...
--insert into Cares (ctuname, pettype, price) values ('harlenglasgow23', 'Lizard', 40);
...
--insert into Cares (ctuname, pettype, price) values ('msquier1', 'Free-range Birds', 90);
...
--insert into Has_Availability (ctuname, s_time, e_time) values ('lailmerag', '2021-06-16', '2021-08-19');
--insert into Has_Availability (ctuname, s_time, e_time) values ('fwoodwingah', '2021-06-07', '2021-08-25');
--insert into Has_Availability (ctuname, s_time, e_time) values ('harlenglasgow23', '2021-03-29', '2021-12-04');
--insert into Has_Availability (ctuname, s_time, e_time) values ('msquier1', '2021-07-18', '2021-09-26');
